...
export const ASK_CRM_CATALOG = [
  ...
  { id: "creative_performance", title: "Anuncios, creatividades y ángulos", example: "Compara anuncios, creatividades y ángulos", route: "/rentabilidad", source: "profitability", aliases: ["anuncios", "creatividades", "angulos", "mejor campana", "campanas"] },
