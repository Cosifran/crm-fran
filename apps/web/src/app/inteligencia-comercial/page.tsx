...
export default function CommercialIntelligencePage() {
  ...
  return <main className="flex flex-col gap-6 p-4 sm:p-6">
    ...
    <Tabs defaultValue="asignacion"><TabsList><TabsTrigger value="asignacion">Asignación simulada</TabsTrigger><TabsTrigger value="aprendizaje">Aprendizaje</TabsTrigger><TabsTrigger value="fugas">Fugas</TabsTrigger></TabsList>
